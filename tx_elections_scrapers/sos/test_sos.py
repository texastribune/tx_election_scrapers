...
class SosFunctionalTest(unittest.TestCase):
    ...
    def test_statewide(self):
        mapping = (
            ('hs-2010_general.html', datetime(2010, 11, 2, 0, 0, 0)),
            ('hs-2010_rep_runoff.html', datetime(2010, 4, 13, 0, 0, 0)),
            ('hs-2011_special_runoff_hd14.html', datetime(2011, 12, 13,)),
            ('hs-2012_general.html', datetime(2012, 11, 6, 0, 0, 0)),
            ('hs-2014_general.html', datetime(2014, 11, 4, 0, 0, 0)),
            ('rs-2010_dem_primary.htm', datetime(2010, 2, 17, 12, 44, 51)),
            ('rs-2010_rep_primary.htm', datetime(2010, 2, 17, 12, 44, 52)),
            ('rs-2012_dem_primary.htm', datetime(2012, 5, 23, 12, 56, 57)),
            ('rs-2012_rep_primary.htm', datetime(2012, 5, 23, 12, 57, 0)),
            ('rs-2014_general.htm', datetime(2014, 11, 10, 17, 7, 56)),
        )
